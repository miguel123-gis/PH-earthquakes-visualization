...
def gif():
    ...
    my_clip = ImageSequenceClip(imgs, fps=3)
    my_clip.write_videofile('eqph.mp4', fps=15)

plotPt()
gif()
"""
NEXT STEPS as of 3 June 2020
1. figure out why a shapely feature isn't working with ax.legend()
2. skip for-loop if file already exists and let it start at the next item after the last
3. convert to script with pandas and geopandas and use csv and cartopy instead
"""
